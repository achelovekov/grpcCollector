...
type GRPCMdtDialout_MdtDialoutClient interface {
	Send(*MdtDialoutArgs___) error
	Recv() (*MdtDialoutArgs___, error)
	grpc.ClientStream
}
...
func (x *gRPCMdtDialoutMdtDialoutClient) Send(m *MdtDialoutArgs___) error {
	return x.ClientStream.SendMsg(m)
}

func (x *gRPCMdtDialoutMdtDialoutClient) Recv() (*MdtDialoutArgs___, error) {
	m := new(MdtDialoutArgs___)
...
// All implementations should embed UnimplementedGRPCMdtDialoutServer
// for forward compatibility
type GRPCMdtDialoutServer interface {
	MdtDialout(GRPCMdtDialout_MdtDialoutServer) error
}

// UnimplementedGRPCMdtDialoutServer should be embedded to have forward compatible implementations.
...
func (x *gRPCMdtDialoutMdtDialoutServer) Send(m *MdtDialoutArgs___) error {
	return x.ServerStream.SendMsg(m)
}

func (x *gRPCMdtDialoutMdtDialoutServer) Recv() (*MdtDialoutArgs___, error) {
	m := new(MdtDialoutArgs___)
